...
func evalPrefixExpression(operator string, right object.Object) object.Object {
	switch operator {
		case "!":
			return evalExclaminationMarkExpression(right)
		case "-":
...
func evalExclaminationMarkExpression(right object.Object) object.Object {
	switch right {
		case TRUE:
			return FALSE
		case FALSE:
...
func evalStringInfixExpression(operator string, left, right object.Object) object.Object {
	if operator != "+" {
		return newError("unkown operator at %s %s %s", left.Type(), operator, right.Type())
	}
